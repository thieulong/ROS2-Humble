...
#include "battery_status/srv/detail/set_led__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
  auto typed_message =
    static_cast<const battery_status::srv::SetLED_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<battery_status::srv::SetLED_Request *>(
    untyped_ros_message);
...
{
  return &battery_status::srv::typesupport_fastrtps_cpp::_SetLED_Request__handle;
}
...
{
  auto typed_message =
    static_cast<const battery_status::srv::SetLED_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<battery_status::srv::SetLED_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &battery_status::srv::typesupport_fastrtps_cpp::_SetLED_Response__handle;
}
...
{
  return &battery_status::srv::typesupport_fastrtps_cpp::_SetLED__handle;
}

...
class Metaclass_SetLED_Request(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            module = import_type_support('battery_status')
        except ImportError:
            import logging
            import traceback
...
class Metaclass_SetLED(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from battery_status.srv import _set_led
...
class SetLED(metaclass=Metaclass_SetLED):
    from battery_status.srv._set_led import SetLED_Request as Request
    from battery_status.srv._set_led import SetLED_Response as Response

...
#include "battery_status/srv/detail/set_led__rosidl_typesupport_fastrtps_c.h"
...
#include "battery_status/msg/rosidl_typesupport_fastrtps_c__visibility_control.h"
...
using _SetLED_Request__ros_msg_type = battery_status__srv__SetLED_Request;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_battery_status
size_t get_serialized_size_battery_status__srv__SetLED_Request(
  const void * untyped_ros_message,
...
static uint32_t _SetLED_Request__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_battery_status__srv__SetLED_Request(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_battery_status
size_t max_serialized_size_battery_status__srv__SetLED_Request(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
...
static size_t _SetLED_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_battery_status__srv__SetLED_Request(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, battery_status, srv, SetLED_Request)() {
...
using _SetLED_Response__ros_msg_type = battery_status__srv__SetLED_Response;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_battery_status
size_t get_serialized_size_battery_status__srv__SetLED_Response(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _SetLED_Response__ros_msg_type * ros_message = static_cast<const _SetLED_Response__ros_msg_type *>(untyped_ros_message);
...
{
  return static_cast<uint32_t>(
    get_serialized_size_battery_status__srv__SetLED_Response(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_battery_status
size_t max_serialized_size_battery_status__srv__SetLED_Response(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
...
static size_t _SetLED_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_battery_status__srv__SetLED_Response(
    full_bounded, is_plain, 0);
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, battery_status, srv, SetLED_Response)() {
...
// already included above
// #include "battery_status/msg/rosidl_typesupport_fastrtps_c__visibility_control.h"
#include "battery_status/srv/set_led.h"
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, battery_status, srv, SetLED)() {

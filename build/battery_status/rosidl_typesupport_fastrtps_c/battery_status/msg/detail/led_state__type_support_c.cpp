...
#include "battery_status/msg/detail/led_state__rosidl_typesupport_fastrtps_c.h"
...
using _LEDState__ros_msg_type = battery_status__msg__LEDState;
...
size_t get_serialized_size_battery_status__msg__LEDState(
  const void * untyped_ros_message,
...
static uint32_t _LEDState__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_battery_status__msg__LEDState(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_battery_status
size_t max_serialized_size_battery_status__msg__LEDState(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
...
static size_t _LEDState__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_battery_status__msg__LEDState(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, battery_status, msg, LEDState)() {

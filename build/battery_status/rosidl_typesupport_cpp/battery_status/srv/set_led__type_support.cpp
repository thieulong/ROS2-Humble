...
static const _SetLED_Request_type_support_symbol_names_t _SetLED_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, battery_status, srv, SetLED_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, battery_status, srv, SetLED_Request)),
  }
};
...
{
  return &::battery_status::srv::rosidl_typesupport_cpp::SetLED_Request_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, battery_status, srv, SetLED_Request)() {
  return get_message_type_support_handle<battery_status::srv::SetLED_Request>();
}
...
static const _SetLED_Response_type_support_symbol_names_t _SetLED_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, battery_status, srv, SetLED_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, battery_status, srv, SetLED_Response)),
  }
};
...
{
  return &::battery_status::srv::rosidl_typesupport_cpp::SetLED_Response_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, battery_status, srv, SetLED_Response)() {
  return get_message_type_support_handle<battery_status::srv::SetLED_Response>();
}
...
static const _SetLED_type_support_symbol_names_t _SetLED_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, battery_status, srv, SetLED)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, battery_status, srv, SetLED)),
  }
};
...
{
  return &::battery_status::srv::rosidl_typesupport_cpp::SetLED_service_type_support_handle;
}
